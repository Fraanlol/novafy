       ...
       <section className="mb-16">
        <div className="flex items-center justify-center flex-col">
           ...
           <div className="flex flex-row services-container">
            <div>
                <img className="w-80 h-72" src="../../public/services-1.jpg" alt="" />
            ...
            <div className="mx-16">
                <img className="w-80 h-72" src="../../public/services-2.jpg" alt="" />
            ...
            <div>
                <img className="w-80 h-72" src="../../public/services-3.jpg" alt="" />
